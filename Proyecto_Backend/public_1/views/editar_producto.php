...
if(isset($_POST["id_producto"])){
    ...
    if(!empty($id)){
        ...
        if(!empty($_FILES["imagen_producto"]["name"])){
            ...
            $query = "UPDATE productos SET nombre_producto = '".$nombre_producto."', precio_producto = '".$precio_producto."',stock_producto = '".$stock_producto."', imagen_producto = '".$imagen_base64."' WHERE id_producto = ".$id;
            $resultado = mysqli_query($conexion, $query);
        }    
        else{
            //la query no incluye la imagen
            $query = "UPDATE productos SET nombre_producto = '".$nombre_producto."', precio_producto = '".$precio_producto."', stock_producto = '".$stock_producto."'WHERE id_producto = ".$id;
            $resultado = mysqli_query($conexion, $query);
        }    
